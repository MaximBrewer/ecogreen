...
class ProductsController extends VoyagerBaseController
{
        ...
        public function show(Request $request, $id)
        {
            ...
            return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted','product_id_for_show',));
        }
        ...
        public function edit(Request $request, $id)
        {
            ...
            $getCategoryItems=ProductsAndCategoryItems::where('product_id',$id)->get();
            $array=[];
            foreach($getCategoryItems as $item){
                array_push($array,$item->cat_items_id);
            }

            return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','categories','array'));
        }
        ...
        public function update(Request $request, $id)
        {
            ...
            ProductsAndCategoryItems::where('product_id',$id)->delete();
            foreach($request->select as $value){
                ProductsAndCategoryItems::create([
                    'product_id'=>$data->id,
                    'cat_items_id'=>$value
                ]);
            }
