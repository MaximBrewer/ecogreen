    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="confirmCheckoutModalSubmit" disabled class="main-button_yellow-disabled not-button main-button main-button_yellow" style="padding: .375rem .75rem;
                font-size: 1rem;
                line-height: 1.5;
                width: auto;
