...
@section('content')
    <div class="container">
        <div class="text-page">
            ...
            <h2 class="main_grey-text text-page__top-h">Справочник по культурам</h2>
                 ...
                 @foreach($posts as $post)
                     <div class="crop-guide-catalog__item" style="background: url({{asset('storage/'.$post->image)}})">
                         <div class="crop-guide-catalog__item-overlay">
                             ...
                             <a href="{{route('crop_guide.product',['slug'=>$post->slug])}}" class="crop-guide-catalog__item-link">Читать далее
